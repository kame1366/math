...
public class App extends JFrame {
	...
	public static void main(String[] args) {
		...
		NumberButton numberButton = app.new NumberButton(currentOp);
		CalcButton calcButton = app.new CalcButton(currentOp);
		ClearButton clearButton = app.new ClearButton();
	}
	...
	public static void appendResult(String c) {
